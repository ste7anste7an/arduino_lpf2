...
void setup() {
    Serial.begin(115200);
    sensor.create_mode("GAMEPAD", true, DATA16, 12, 5, 0,0.0f,512.0f,0.0f,1024.0f,0.0f,100.0f,"XYBD",ABSOLUTE,ABSOLUTE); //map in and map out unit = "XYBD" = x, y, buttons, d-pad
